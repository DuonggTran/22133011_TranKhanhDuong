<%-- <%@page import="LapTrinhWebT4_3.models.UserModel"%>
<%@page import="LapTrinhWebT4_3.controllers.WaitingController"%>
...
<%@page import="LapTrinhWebT4.models.UserModel"%>
<%@page import="LapTrinhWebT4.controllers.WaitingController"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<html>
<head>
